...
URL | filename | username | password"""
    ...
    RCHD_TG_API_LIMIT = "Diunduh dalam {} detik.\nUkuran File Terdeteksi: {}\nMaaf. Tetapi, saya tidak dapat mengunggah file yang lebih besar dari 2GB karena keterbatasan API Telegram."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Terima kasih telah menggunakan bot @ccgnimex_bot </b>"
